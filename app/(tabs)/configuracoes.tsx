...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Image, Switch, Linking, Platform } from 'react-native';
    ...
    >
      ...
      <View style={[styles.card, { backgroundColor: colors.card }]}>
        ...
        <Text style={[styles.aboutText, { color: colors.text }]}>
          Este é um protótipo para mapeamento de pátio da Mottu, permitindo visualizar e gerenciar a localização das motos no pátio de forma interativa.
        </Text>
